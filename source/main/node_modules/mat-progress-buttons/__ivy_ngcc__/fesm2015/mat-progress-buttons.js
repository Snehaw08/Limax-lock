...
MatSpinnerButtonComponent.ɵfac = function MatSpinnerButtonComponent_Factory(t) { return new (t || MatSpinnerButtonComponent)(ɵngcc0.ɵɵdirectiveInject(GLOBAL_CONFIG)); };
...
MatBarButtonComponent.ɵfac = function MatBarButtonComponent_Factory(t) { return new (t || MatBarButtonComponent)(ɵngcc0.ɵɵdirectiveInject(GLOBAL_CONFIG)); };
MatBarButtonComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: MatBarButtonComponent, selectors: [["mat-bar-button"]], hostBindings: function MatBarButtonComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("click", function MatBarButtonComponent_click_HostBindingHandler($event) { return ctx.handleClick($event); });
